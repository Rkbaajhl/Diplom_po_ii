...
image = cv2.imread('C:\\Diplom_po_ii\\123.png') #Вставлять путь изображения числ
imagen = cv2.resize(image, None, fx=10, fy=10, interpolation=cv2.INTER_CUBIC)
cv2.imwrite("C:\\Diplom_po_ii\\trash1.png", imagen) #Увечличение изображения
...
image_path = 'C:\\Diplom_po_ii\\trash1.png' #Вставить пусть с увеличенным изображением
process_image(image_path)

recognized_number = recognize_number('C:\\Diplom_po_ii\\trash11.png')# вставить путь сохранненого обработанного изображения
